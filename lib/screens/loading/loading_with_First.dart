...
class LoadingWithFirstScreen extends StatefulWidget {
  const LoadingWithFirstScreen({Key? key}) : super(key: key);

  @override
  _LoadingWithFirstScreenState createState() {
    return _LoadingWithFirstScreenState();
  }
}

class _LoadingWithFirstScreenState extends State<LoadingWithFirstScreen> {
  double _opacity = 0.0;
  double? _percent;
            ...
            children: <Widget>[
              ...
              Column(
                ...
                children: [
                  ...
                  Text('يرجى الانتظار .. يتم التشغيل لأول مرة',
